  ...
  let s:guishade0 = "#27212e"
  let s:guishade1 = "#46414c"
  let s:guishade2 = "#65606a"
  let s:guishade3 = "#848088"
  let s:guishade4 = "#a2a0a5"
  let s:guishade5 = "#c1c0c3"
  let s:guishade6 = "#e0dfe1"
  let s:guishade7 = "#ffffff"
  let s:guiaccent0 = "#b381c5"
  let s:guiaccent1 = "#ffe261"
  let s:guiaccent2 = "#eb64b9"
  let s:guiaccent3 = "#b4dce7"
  let s:guiaccent4 = "#716385"
  let s:guiaccent5 = "#74dfc4"
  let s:guiaccent6 = "#40b4c4"
  let s:guiaccent7 = "#b381c5"
  let s:ctermshade0 = 235
  let s:ctermshade1 = 238
  let s:ctermshade2 = 102
  let s:ctermshade3 = 244
  let s:ctermshade4 = 247
  let s:ctermshade5 = 251
  let s:ctermshade6 = 254
  let s:ctermshade7 = 231
  let s:ctermaccent0 = 182
  let s:ctermaccent1 = 222
  let s:ctermaccent2 = 212
  let s:ctermaccent3 = 189
  let s:ctermaccent4 = 103
  let s:ctermaccent5 = 116
  let s:ctermaccent6 = 80
  ...
  exec "hi IncSearch guifg=".s:guiaccent3." guibg=".s:guishade1
  exec "hi IncSearch ctermfg=".s:ctermaccent3." ctermbg=".s:ctermshade1
  ...
  exec "hi Search guifg=".s:guiaccent3." guibg=".s:guishade1
  exec "hi Search ctermfg=".s:ctermaccent3." ctermbg=".s:ctermshade1
