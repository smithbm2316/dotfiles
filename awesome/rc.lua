...
mytextclock = wibox.widget.textclock(' %a %b %e, %I:%M%P ', 30)
...
globalkeys = gears.table.join(
  ...
  awful.key({ modkey, 'Control' }, 'e', function() awful.spawn('splatmoji copy') end,
            {description = 'Copy emoji to clipboard (rofi)', group = 'launcher'}),
  ...
  awful.key({ modkey }, 'Print', function () awful.spawn('flameshot screen --clipboard') end,
...
clientkeys = gears.table.join(
  ...
  awful.key({ modkey, }, 'e',      function (c) c.ontop = not c.ontop            end,
