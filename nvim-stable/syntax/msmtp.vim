...
" URL:          https://github.com/wogong/msmtp.vim
...
syntax match msmtpOption /\<\(auto_from\|from\|maildomain\|dsn_notify\|dsn_return\|keepbcc\|logfile\|syslog\|set_from_header\|from_full_name\|set_date_header\|set_msgid_header\)\>/
