...
(function KeyboardShortcut() {
    ...
    // Ctrl-k and Ctrl-j to scroll up/down by half page
    registerBind("J", true, false, false, appScrollHalfDown);
    registerBind("K", true, false, false, appScrollHalfUp);
    ...
    function appScrollHalfDown() {
        const app = focusOnApp();
        if (app) {
            app.scrollBy(0, SCROLL_STEP * 10);
        }
    }

    function appScrollHalfUp() {
        const app = focusOnApp();
        if (app) {
            app.scrollBy(0, -SCROLL_STEP * 10);
        }
